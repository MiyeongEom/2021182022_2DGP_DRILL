...
key_event_table = {
    (SDL_KEYDOWN, SDLK_RIGHT): RD,  #Ctrl+d
...
class Boy:
    ...
    def update(self):
        ...
        if self.event_que:
            ...
            except KeyError: # 예외 처리, 에러 처리 / C++과 비슷
    ...
    def fire_ball(self):
        print('Fire ball')
        #공을 만들어줘야함, 발사시점에
        ball = Ball(self.x, self.y, self.face_dir*2) # self: 소년
